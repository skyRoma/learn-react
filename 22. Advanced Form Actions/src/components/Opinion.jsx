...
export function Opinion({ opinion: { id, title, body, userName, votes } }) {
  ...
  const [upvoteFormState, upvoteFormAction, isUpvotePending] = useActionState(upvoteAction);
  const [downvoteFormState, downvoteFormAction, isDownvotePending] = useActionState(downvoteAction);
